...
//        }
    ...
    public int countHotels(boolean unique) {
        List<String> hotelNames = hotelRepository.findAllHotelNames();

        if (unique) {
            Set<String> uniqueHotelNames = new HashSet<>(hotelNames);
            return uniqueHotelNames.size();
        } else {
